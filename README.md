...
--> Create ks.preseed file in home directory and copy the content in above step-4 and paste it in ks.preseed file.  
...
5) Finally save the new iso file. Instead of Step-5 in above, it's here  
